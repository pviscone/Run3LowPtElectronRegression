...
from utils.features import tk_features, common_features, to_log, caloEB_features, combined_features
...
caloModel = SingleMVENet.load("plots/calo/epoch_1003")
tkModel = SingleMVENet.load("plots/track/epoch_1001")

caloF, caloSigma = caloModel.f(df[common_features + caloEB_features].to_numpy())
...
features_eb = ["LPEle_ECorrCalo", "LPEle_varCalo", "LPEle_pCorrTk", "LPEle_varTk"] + common_features + combined_features
