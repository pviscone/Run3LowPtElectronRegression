...
sys.path.append("../../..")
from utils.features import caloEE_features, common_features, to_log
...
features_ee = common_features + caloEE_features
...
ax.legend()
fig.savefig("plots/calo/loss_ee.pdf")
...
#booster.save_model("BDT_caloEE_quantile.json")
# %%
